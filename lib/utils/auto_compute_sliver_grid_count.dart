...
/*class AutoComputeSliverGridCount {
  // static final double smallCardWidth = WidgetStyleCommons.videoCardWidth;
  ...
  static SliverGridDelegateWithExtentAndRatio videoCardHDelegate(
      ...
      SliverGridDelegateWithExtentAndRatio(
        mainAxisSpacing: 2,
        maxCrossAxisExtent: StyleConstant.videoCardWidth * 2,
        childAspectRatio: StyleConstant.videoCardAspectRatio * 2.2,
